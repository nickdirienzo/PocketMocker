...
public class ObjectivesManager extends ModelManager {
    ...
    public boolean hasMocks(String objectiveName) {
        ...
        Cursor c = db.query(MockLocation.TABLE_NAME, null, MockLocation.COL_RECORDING + "=?",
                new String[] {
                    String.valueOf(o.getRecordingId())
                }, null,
                null, null);
        Cursor c2 = db.query(MockSensorEvent.TABLE_NAME, null, MockSensorEvent.COL_RECORDING + "=?",
                new String[] {
                    String.valueOf(o.getRecordingId())
                }, null,
                null, null);
        boolean b = c.getCount() > 0 || c2.getCount() > 0;
        c.close();
        c2.close();
        manager.closeDatabase();
        return b;
